...
import * as Icon from 'beeicons';
import clipboardCopy from 'clipboard-copy';

type BeeIconComponent = React.FC<{ size?: number; className?: string }>;
  ...
  return (
    <>
      <div className="searchContainer">
        ...
        />
        <Icon.SearchIcon size={20} className="searchIcon" />
      </div>

      <div className="iconList">
        {filteredIcons.map((icon, index) => {
          const IconComponent = Icon[icon as keyof typeof Icon] as BeeIconComponent;
          return (
